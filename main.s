...
main:
	...
	call seedInit
	call getRandNum			#calling subroutine in main.s
	movia r20, RANDOM_NUM	#initialize first random number
	stw r2, 0(r20)
...
endgame:
	...
	movia r21, USER_SCORE			#get user score
	ldw r4, 0(r21)
...
CORRECT_ANSWER:
	...
	addi r17, r17, 0b01
	stw r17, 0(r16)
	call getRandNum					#get next random number, returned in r4
	movia r20, RANDOM_NUM	
	stw r2, 0(r20)
